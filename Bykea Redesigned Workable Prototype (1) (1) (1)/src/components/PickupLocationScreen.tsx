...
export function PickupLocationScreen({ onNavigate }: PickupLocationScreenProps) {
  return (
    <div className="flex flex-col h-screen bg-[#F8FAF9]">
      ...
      <div className="bg-white border-b-2 border-[#d0d0d0] px-5 py-5">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-[#1F1F1F]">Step 1 of 3</h2>
        </div>
        <p className="text-[#5a5a5a] ml-14">Select Pickup Location</p>
      </div>
      ...
      <div className="relative flex-1 bg-gradient-to-br from-[#e8f5e9] to-[#c8e6c9]">
        <div className="absolute inset-0 flex items-center justify-center">
          <MapPin className="w-20 h-20 text-[#6CAC78] animate-bounce" strokeWidth={2} />
        </div>
        
        {/* Instruction */}
        <div className="absolute top-6 left-0 right-0 mx-5">
          <div className="bg-white rounded-2xl shadow-lg p-4 text-center">
            <p className="text-[#1F1F1F]">Move the pin to your pickup location</p>
          </div>
        </div>
      </div>
